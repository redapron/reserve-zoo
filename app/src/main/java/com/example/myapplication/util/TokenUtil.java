...
public class TokenUtil {
    ...
    public static void saveToken(String data, Context context) {
        try {
    ...
    public static void saveUser(String data, Context context) {
        try {
            OutputStreamWriter outputStreamWriter = null;
            outputStreamWriter = new OutputStreamWriter(context.openFileOutput("user.txt", Context.MODE_PRIVATE));
            outputStreamWriter.write(data);
            outputStreamWriter.close();
        } catch (IOException e) {
            Log.e("Exception", "File write failed: " + e.toString());
